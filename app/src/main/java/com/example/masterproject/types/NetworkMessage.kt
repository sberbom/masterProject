...
data class NetworkMessage(val sender: String, val payload: String, val messageType: String, val signature: String = "", val nonce: Int = 0, val sequenceNumber: Int = 0, val lastSequenceNumber: Int = 0) {
    ...
    companion object {
        fun decodeNetworkMessage(string: String): NetworkMessage {
            ...
            return NetworkMessage(sender, payload, messageType, signature, nonce, sequenceNumber, lastSequenceNumber)
        }
    }
}